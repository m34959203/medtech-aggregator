...
**Двуязычие RU/KK** — переключатель в шапке; UI, описания/названия услуг и ответы ИИ адаптируются к языку:

[![Қазақша](docs/screenshots/home-kk-desktop.png)](docs/screenshots/home-kk-desktop.png)
