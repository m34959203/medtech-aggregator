    ...
    <section className="relative overflow-hidden border-b border-ink-100 bg-white">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-16 pt-14 sm:px-6 sm:pt-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="text-balance text-3xl font-bold leading-tight tracking-tight text-ink-900 sm:text-5xl">
            Сравните цены на медуслуги
            <span className="block text-brand-600">и не переплачивайте</span>
          </h1>
          <p className="mx-auto mt-5 max-w-xl text-pretty text-base text-ink-500 sm:text-lg">
